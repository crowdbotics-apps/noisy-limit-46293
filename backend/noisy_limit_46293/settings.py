"""
Django settings for noisy_limit_46293 project.
...
ROOT_URLCONF = 'noisy_limit_46293.urls'
...
WSGI_APPLICATION = 'noisy_limit_46293.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_limit_46293 API",
    "DESCRIPTION": "API documentation for noisy_limit_46293 App",
    "VERSION": "v1",
}
